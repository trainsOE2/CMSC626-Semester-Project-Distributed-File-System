...
def change_directory(main_dir, wanted_filename, s_socket, communication_socket, client_address):
    if wanted_filename == ".":
        ...
        send_response_to_client("S2: Directory changes successfully", communication_socket)
    else:
        send_response_to_client("S2: Directory doesn't exist", communication_socket)
    communication_socket.close()
    print(f'Communication with {client_address} ended!')
...
def main():
    ...
    while True:
        ...
        if client_message_0 == "cd":
            change_directory(main_dir, ".", s_socket, communication_socket, client_address)
